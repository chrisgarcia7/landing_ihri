...
export default function CardProductos() {
  ...
  const prueba = () => {
    console.log("prueba de boton funcionando")
  }
      ...
      {productos.length > 0 ? (
        productos.map((producto) => (
          <div className="room__card" key={producto.idProducto}>
            ...
            <button type="button" style={{ alignSelf: "center", justifyContent: "center",  }} className="btn btn-success">Consultar<svg style={{ marginLeft: "5px" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
